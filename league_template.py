...
players = [['player_a_name', 'player_a_team_name', 'player_a_note'],
           ...
           ['none', '', 'fake player for bye results etc']]
...
rnd_1 = [[1, 'player_a_name', 100, 'player_b_name', 0],
...
mask = standings_df['player'] != 'none'
standings_df[mask].to_csv(filename+"_standings.csv", index=False)
